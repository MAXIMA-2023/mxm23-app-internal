...
import { Center, Box, Text, HStack, Flex, Image, Divider } from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <Box w={"full"} pt={["4em", "4em", "4em", "0em"]} pl={["0", "0", "0", "17em", "19em"]}>
          <Box>
              <Text fontSize={"4xl"} fontWeight={"medium"} textColor={"#1E1D22"}>
                  Dashboard
              </Text>
          </Box>
          <Flex w={"full"} minH={["95vh", "95vh", "auto", "86vh", "86vh"]} bgColor={"white"} borderRadius={"2xl"} boxShadow={"lg"}>
            <Box w={"full"} p={"2em"}>
